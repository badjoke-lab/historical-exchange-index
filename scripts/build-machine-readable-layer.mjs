...
const mainRoutes = ['/', '/dead/', '/active/', '/exchange/{slug}/', '/stats/', '/updates/', '/incidents/', '/methodology/', '/about/', '/donate/']
...
writeJson('version.json', {
  ...
  routes: {
    ...
    stats: '/stats/', updates: '/updates/', incidents: '/incidents/', methodology: '/methodology/', about: '/about/', donate: '/donate/',
  },

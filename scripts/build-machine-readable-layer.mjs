...
const mainRoutes = ['/', '/dead/', '/active/', '/exchange/{slug}/', '/explore/', '/compare/', '/stats/', '/quality/', '/updates/', '/incidents/', '/monthly/', '/methodology/', '/about/', '/donate/']
...
writeJson('version.json', {
  ...
  routes: {
    home: '/', dead: '/dead/', active: '/active/', exchange_detail: '/exchange/{slug}/', explorer: '/explore/', compare: '/compare/',

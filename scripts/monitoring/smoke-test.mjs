...
import { buildCanonicalMetrics, parseReviewMonth } from '../review/monthly-review-core.mjs';
...
async function main() {
  ...
  const monthlyMetrics = buildCanonicalMetrics(canonicalData, reviewMonth);
  assert(reviewMonth.previousMonth === '2026-04', 'monthly review previous month is incorrect');

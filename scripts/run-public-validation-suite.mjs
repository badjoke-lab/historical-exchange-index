...
const checks = [
  ...
  ['public metadata v2', ['scripts/audit-public-metadata-v2.mjs']],
  ...
  ['Explorer query self-test', ['scripts/test-explorer-query-contract.mjs']],
  ['Compare v1 self-test', ['scripts/audit-compare-v1.mjs', '--self-test']],
  ['Compare v1', ['scripts/audit-compare-v1.mjs']],
  ['i18n foundation validation', ['scripts/validate-i18n-foundation.mjs']],
  ['i18n foundation test', ['scripts/test-i18n-foundation.mjs']],

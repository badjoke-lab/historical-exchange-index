...
After D-1000 batch BX13, the projected reviewed state is:
...
The localization decision remains HOLD. Translation breadth is not expanded by BX13, and third-language authorization remains false.

...
After D-1000 batch BX49, the reviewed state is:
...
The localization decision remains HOLD. Translation breadth is not expanded by BX49, and third-language authorization remains false.

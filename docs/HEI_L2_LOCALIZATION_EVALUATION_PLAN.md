...
After D-1000 batch BX12, the projected reviewed state is:
...
The localization decision remains HOLD. Translation breadth is not expanded by BX12, and third-language authorization remains false.

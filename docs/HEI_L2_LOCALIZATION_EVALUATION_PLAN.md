...
After D-1000 batch BX15, the projected reviewed state is:
...
The localization decision remains HOLD. Translation breadth is not expanded by BX15, and third-language authorization remains false.

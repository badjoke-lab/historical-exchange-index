...
Current BX16 identifiers:

```text
Maximum added entity ID:   hei_ex_000981
Maximum event ID:          hei_ev_010080
Maximum added evidence ID: hei_src_012177
```
...
Events:   1004
Evidence: 3481
Remaining: 139 reviewed entities
```
...
At the BX16 checkpoint, recovery should resolve:

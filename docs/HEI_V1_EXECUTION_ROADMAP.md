...
docs/audits/HEI_D1000_PROGRESS_BX27_2026-07-24.md
...
Current BX27 identifiers:

```text
Maximum added entity ID:   hei_ex_001025
Maximum event ID:          hei_ev_010081
Maximum added evidence ID: hei_src_012267
```
...
Events:   1005
Evidence: 3571
Remaining: 95 reviewed entities
```
...
At the BX27 checkpoint, recovery should resolve:

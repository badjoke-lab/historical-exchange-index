> Correction: duplicate entity `hei_ex_000419` was removed and its useful event/evidence material was migrated to canonical `hei_ex_000012`. This memo remains as backlog-processing history.

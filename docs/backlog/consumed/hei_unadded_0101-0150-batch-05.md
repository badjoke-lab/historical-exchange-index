...
| `hei_unadded_0148` | `hei_ex_000558` Beam Swap | Added as the active native AMM of the Beam gaming network. |
...
- Beam Swap uses a month-level `2023-09-01` launch marker because Beam mainnet launched in September 2023 but an exact standalone DEX launch day was not recovered.

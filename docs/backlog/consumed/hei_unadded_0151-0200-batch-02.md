...
|---|---|---|
| `hei_unadded_0178`-`0179` | existing `hei_ex_000308` Binance JEX | Strengthened with reviewed acquisition, shutdown, and evidence records; no duplicate entity created. |
...
- Binance JEX spot and futures rows are one exchange identity and map to existing canonical `hei_ex_000308`.
...
- duplicate JEX spot/futures rows were collapsed into the existing entity

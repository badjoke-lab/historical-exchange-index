# HEI Post-D1000 Growth BX102 — FYB-SG
...
- canonical entity: `hei_ex_001195`
...
Event `hei_ev_010249` is modeled as `shutdown_announced` on 2019-02-26, the dated observation of the closure notice, rather than as `shutdown_effective`.

## Evidence

- `hei_src_012819` — The Business Times — contemporary identity/origin evidence.
- `hei_src_012820` — Cryptowisser — dated reproduction of FYB-SG's closure notice.
- `hei_src_012821` — Bitcointalk — low-reliability corroboration reproducing the same notice.
- `hei_src_012822` — Blockspot — current inactive/dead-domain historical profile.

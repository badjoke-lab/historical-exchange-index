# HEI Auto Monitoring Report - 20260921

## Run

- run_id: 20260921-084655
- mode: scheduled-external
- started_at: 2026-09-21T08:46:55.075Z
- finished_at: 2026-09-21T08:48:02.468Z
- meaningful_findings: yes

## Noise control

- total_findings_seen: 1613
- visible_findings: 1325
...
- Latest Crypto — review_and_stage_public_quality_record
- App NoOnes — review_and_stage_public_quality_record
- Aggregator Odos — review_and_stage_public_quality_record
- Tether-backed — review_and_stage_public_quality_record

## B candidates

- OSL Exchange — hold_for_active_baseline_or_batch_add
- Extended Perps — hold_for_active_baseline_or_batch_add
- Lighter Robinhood Perps — hold_for_active_baseline_or_batch_add
- AZverse Perps — hold_for_active_baseline_or_batch_add
- NEMO Trading — hold_for_active_baseline_or_batch_add
- Katana DEX — hold_for_active_baseline_or_batch_add
- MetalX Swap — hold_for_active_baseline_or_batch_add
- HertzFlow — hold_for_active_baseline_or_batch_add
...
- Pham Regarding — hold_for_regulatory_scope_review

## Critical / high alerts

- [high] Official site check parked_or_for_sale: 10KSwap (active-status-watch) — investigate_active_status_and_domain_repurpose
- [high] Active-side entity has death_reason: ExMarkets (evidence-and-record-quality-watch) — remove_or_review_death_reason
- [high] Active-side entity has death_reason: Exrates (evidence-and-record-quality-watch) — remove_or_review_death_reason
- [high] Active-side entity has death_reason: ExtStock (evidence-and-record-quality-watch) — remove_or_review_death_reason
- [high] Active-side entity has death_reason: EXX (evidence-and-record-quality-watch) — remove_or_review_death_reason
- [high] Active-side entity has death_reason: FatBTC (evidence-and-record-quality-watch) — remove_or_review_death_reason
- [high] Active-side entity has death_reason: Folgory (evidence-and-record-quality-watch) — remove_or_review_death_reason
- [high] Active-side entity has death_reason: FYB-SG (evidence-and-record-quality-watch) — remove_or_review_death_reason
- [high] Active-side entity has death_reason: GetBTC (evidence-and-record-quality-watch) — remove_or_review_death_reason
- [high] Evidence source URL issue: hei_src_012766 (evidence-health-watch) — find_archive_or_replacement_evidence
- [high] Evidence source URL issue: hei_src_012767 (evidence-health-watch) — find_archive_or_replacement_evidence
...
- [B] Pham Regarding — Commodity Futures Trading Commission — hold_for_regulatory_scope_review
...
- [low] Possible successor/predecessor link missing: McxNOW — review_lineage_fields_when_record_is_touched
...
- [medium] Entity has no event records: Aban Tether — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Aborean Finance — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Accumulus — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: Aktionariat — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: Ambient — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: AnyHedge — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: Arcus — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Arkham Exchange — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: Arkham Exchange — review_lineage_fields_when_record_is_touched
...
- [medium] Entity has no event records: AwakenSwap — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: belo — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: BGE — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: Binance TH — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: BitMake — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Bitonic — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: Bitonic — review_lineage_fields_when_record_is_touched
- [medium] Entity has no event records: Bitowex — add_minimum_event_or_review_record_shape
- [medium] Provisional text found: Bitowex — replace_provisional_notes_with_reviewed_text
- [low] Possible successor/predecessor link missing: BITPOINT — review_lineage_fields_when_record_is_touched
...
- [medium] Entity has no event records: Bixin.com — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: Brasil Bitcoin — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: Bullet — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: Bullet — review_lineage_fields_when_record_is_touched
- [medium] Entity has no event records: Bumpin Trade — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: Bumpin Trade — review_lineage_fields_when_record_is_touched
- [medium] Entity has no event records: BurjX — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: Burve — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Busha — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: CaspianEx — add_minimum_event_or_review_record_shape
...
- [low] Possible successor/predecessor link missing: CoinCatch — review_lineage_fields_when_record_is_touched
- [low] Possible successor/predecessor link missing: CoinChief — review_lineage_fields_when_record_is_touched
...
- [medium] Entity has no event records: Coinext — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: Coinlocally — add_minimum_event_or_review_record_shape
- [medium] Provisional text found: Coinlocally — replace_provisional_notes_with_reviewed_text
- [medium] Entity has no event records: Coinmate — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Coinmerce — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: Coinmerce — review_lineage_fields_when_record_is_touched
...
- [medium] Entity has no event records: Coinstash — add_minimum_event_or_review_record_shape
...
- [low] official_url_status unknown: CometDEX — review_official_url_status_when_available
...
- [medium] Entity has no event records: Contango V2 — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: Contango V2 — review_lineage_fields_when_record_is_touched
- [medium] Entity has no event records: Convergence Finance — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: COREDAX — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: Crystal Exchange — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: DeltaDA — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: Deri Protocol — add_minimum_event_or_review_record_shape
...
- [low] official_url_status unknown: DeversiFi — review_official_url_status_when_available
...
- [medium] Entity has no event records: DFX Labs — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Dfyn — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: DIFX — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: digitalexchange.id — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Digitra.com — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: EarnBIT — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: EX.IO — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Exbitron — add_minimum_event_or_review_record_shape
...
- [high] Active-side entity has death_reason: ExMarkets — remove_or_review_death_reason
- [medium] Entity has no event records: ExMarkets — add_minimum_event_or_review_record_shape
- [high] Active-side entity has death_reason: Exrates — remove_or_review_death_reason
- [medium] Entity has no event records: Extended — add_minimum_event_or_review_record_shape
- [high] Active-side entity has death_reason: ExtStock — remove_or_review_death_reason
- [medium] Entity has no event records: ExtStock — add_minimum_event_or_review_record_shape
- [high] Active-side entity has death_reason: EXX — remove_or_review_death_reason
- [medium] Entity has no event records: EXX — add_minimum_event_or_review_record_shape
- [low] official_url_status unknown: ezBtc — review_official_url_status_when_available
...
- [medium] Entity has no event records: Fasset — add_minimum_event_or_review_record_shape
- [high] Active-side entity has death_reason: FatBTC — remove_or_review_death_reason
- [medium] Entity has no event records: FatBTC — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: Finst — add_minimum_event_or_review_record_shape
...
- [low] official_url_status unknown: Fisco Cryptocurrency Exchange — review_official_url_status_when_available
- [medium] Entity has no event records: Fiwind — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: Fiwind — review_lineage_fields_when_record_is_touched
...
- [medium] Entity has no event records: Flash Trade — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: Flash Trade — review_lineage_fields_when_record_is_touched
...
- [medium] Entity has no event records: Flybit — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: FMFW.io — review_lineage_fields_when_record_is_touched
- [medium] Entity has no event records: FOBL — add_minimum_event_or_review_record_shape
- [high] Active-side entity has death_reason: Folgory — remove_or_review_death_reason
- [medium] Entity has no event records: Folgory — add_minimum_event_or_review_record_shape
...
- [high] Active-side entity has death_reason: FYB-SG — remove_or_review_death_reason
- [low] Possible successor/predecessor link missing: FYB-SG — review_lineage_fields_when_record_is_touched
...
- [medium] Entity has no event records: GCB Exchange — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: GDAC — add_minimum_event_or_review_record_shape
- [high] Active-side entity has death_reason: GetBTC — remove_or_review_death_reason
- [low] official_url_status unknown: GetBTC — review_official_url_status_when_available
...
- [low] official_url_status unknown: Globitex — review_official_url_status_when_available
...
- [low] country_or_origin unknown: Graviex — add_origin_if_sourceable
...
- [medium] Entity has no event records: GroveX — add_minimum_event_or_review_record_shape
...
- [low] official_url_status unknown: Hanbitco — review_official_url_status_when_available
- [low] Possible successor/predecessor link missing: Hanbitco — review_lineage_fields_when_record_is_touched
...
- [low] Possible successor/predecessor link missing: HashKey Japan — review_lineage_fields_when_record_is_touched
...
- [low] official_url_status unknown: HCoin — review_official_url_status_when_available
- [medium] Entity has no event records: Heaven — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Hegic — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: HKbitEX — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: HKVAX — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Hodl Hodl — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: Hodl Hodl — review_lineage_fields_when_record_is_touched
...
- [low] official_url_status unknown: Hubi — review_official_url_status_when_available
...
- [low] country_or_origin unknown: iCoinbay — add_origin_if_sourceable
...
- [medium] Entity has no event records: INEX — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: InkSwap — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: InkySwap — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Intebix — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: INX One — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: INX One — review_lineage_fields_when_record_is_touched
- [medium] Provisional text found: IZAKA-YA — replace_provisional_notes_with_reviewed_text
- [low] Possible successor/predecessor link missing: IZAKA-YA — review_lineage_fields_when_record_is_touched
- [medium] Entity has no event records: Kanga Global — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: KDX — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Kinesis Money — add_minimum_event_or_review_record_shape
...
- [low] Possible successor/predecessor link missing: Klickl — review_lineage_fields_when_record_is_touched
- [medium] Entity has no event records: Kodiak — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: KoinBX — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Koinpark — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Kriya — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Kumbaya — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: LATOKEN — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: LATOKEN — review_lineage_fields_when_record_is_touched
- [medium] Entity has no event records: LCT — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Lemon — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: LeveX — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: LFJ — review_lineage_fields_when_record_is_touched
- [medium] Entity has no event records: Lighter — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: Lithos — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Lunarbase — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Lynex — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Lynx Finance — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: Lynx Finance — review_lineage_fields_when_record_is_touched
- [medium] Entity has no event records: M2 — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: M2 — review_lineage_fields_when_record_is_touched
...
- [medium] Entity has no event records: MAX Exchange — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: MB.IO — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Merchant Moe — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Metal X — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: MidChains — add_minimum_event_or_review_record_shape
- [low] official_url_status unknown: Mine Digital — review_official_url_status_when_available
- [low] Possible successor/predecessor link missing: Mine Digital — review_lineage_fields_when_record_is_touched
...
- [medium] Entity has no event records: Monday Trade — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Moneybees — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: Mudrex — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: MUX Protocol — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: MX Global — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Nabla Finance — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Nado — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Nanovest — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: NBX — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Ndax — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: Ndax — review_lineage_fields_when_record_is_touched
- [medium] Entity has no event records: Neoxa Exchange — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: Neoxa Exchange — review_lineage_fields_when_record_is_touched
...
- [medium] Entity has no event records: Netcoins — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: NILE — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Niza.io — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: NonKYC.io — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Nordstern.Finance — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: NovaDAX — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: NovaDAX — review_lineage_fields_when_record_is_touched
- [medium] Entity has no event records: NOXA — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Ofza — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: One Trading — review_lineage_fields_when_record_is_touched
...
- [medium] Entity has no event records: Orbix — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: Orbix — review_lineage_fields_when_record_is_touched
- [medium] Entity has no event records: Orderly Network — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: P2B — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: P2B — review_lineage_fields_when_record_is_touched
...
- [medium] Entity has no event records: PantherTrade — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: Paxful — review_lineage_fields_when_record_is_touched
- [medium] Entity has no event records: Paymium — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: Paymium — review_lineage_fields_when_record_is_touched
- [medium] Entity has no event records: Perennial — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Perpl — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: PointPay — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Pool Party — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Prism DEX — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: Purps — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Quidax — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: RISEx — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: S.BLOX — add_minimum_event_or_review_record_shape
- [medium] Provisional text found: SAFEbit — replace_provisional_notes_with_reviewed_text
- [low] Possible successor/predecessor link missing: SAFEbit — review_lineage_fields_when_record_is_touched
- [medium] Entity has no event records: Safello — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: SafeTrade — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: SakuraSwap — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Samuel Kripto — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Satori Finance — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: Satori Finance — review_lineage_fields_when_record_is_touched
- [medium] Entity has no event records: Satoshi Tango — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: SecondBTC — add_minimum_event_or_review_record_shape
...
- [low] official_url_status unknown: Shelbit — review_official_url_status_when_available
- [medium] Entity has no event records: SINEGY — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Skate AMM — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: SquidSwap — add_minimum_event_or_review_record_shape
- [low] official_url_status unknown: SquidSwap — review_official_url_status_when_available
- [medium] Entity has no event records: StandX — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: StandX — review_lineage_fields_when_record_is_touched
- [medium] Entity has no event records: Stellar DEX — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Storm Trade — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: SuiDex — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: TDX — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: Tessera V — add_minimum_event_or_review_record_shape
- [low] official_url_status unknown: Tessera V — review_official_url_status_when_available
- [medium] Entity has no event records: Tokpie — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Topaz — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: TurboFlow — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: TurboFlow — review_lineage_fields_when_record_is_touched
- [medium] Entity has no event records: Unocoin — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Upbit Singapore — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Upbit Thailand — add_minimum_event_or_review_record_shape
...
- [medium] Entity has no event records: Variational — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: Variational — review_lineage_fields_when_record_is_touched
- [medium] Entity has no event records: VDX — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Verus Market — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Vest Markets — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: Vest Markets — review_lineage_fields_when_record_is_touched
- [medium] Entity has no event records: WAANX — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: WannaSwap — add_minimum_event_or_review_record_shape
- [low] official_url_status unknown: WannaSwap — review_official_url_status_when_available
- [low] Possible successor/predecessor link missing: Webot — review_lineage_fields_when_record_is_touched
- [medium] Entity has no event records: Websea — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: WinnieSwap — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: World Markets — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: WX Network — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: WX Network — review_lineage_fields_when_record_is_touched
- [medium] Entity has no event records: XBO.com — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: XRPL DEX — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: YAX — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Yhego — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: YoBit — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: YoBit — review_lineage_fields_when_record_is_touched
- [medium] Entity has no event records: Young Platform — add_minimum_event_or_review_record_shape
- [medium] Entity has no event records: Z.com EX — add_minimum_event_or_review_record_shape
- [low] official_url_status unknown: Zipmex — review_official_url_status_when_available
- [medium] Entity has no event records: Zoomex — add_minimum_event_or_review_record_shape
- [low] Possible successor/predecessor link missing: Zoomex — review_lineage_fields_when_record_is_touched
...
- [low] Evidence archived_url missing: hei_src_012203 — add_archive_when_record_is_touched
...
- [low] Evidence archived_url missing: hei_src_012211 — add_archive_when_record_is_touched
...
- [low] Evidence archived_url missing: hei_src_012538 — add_archive_when_record_is_touched
...
- [low] Evidence archived_url missing: hei_src_012534 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012270 — add_archive_when_record_is_touched
...
- [low] Evidence archived_url missing: hei_src_012530 — add_archive_when_record_is_touched
...
- [low] Evidence archived_url missing: hei_src_012309 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012312 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012542 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012543 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012774 — add_archive_when_record_is_touched
...
- [low] Evidence archived_url missing: hei_src_012338 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012342 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012217 — add_archive_when_record_is_touched
...
- [low] Evidence archived_url missing: hei_src_012278 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012766 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012767 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012768 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012306 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012366 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012336 — add_archive_when_record_is_touched
...
- [low] Evidence archived_url missing: hei_src_012241 — add_archive_when_record_is_touched
...
- [low] Evidence archived_url missing: hei_src_012528 — add_archive_when_record_is_touched
...
- [low] Evidence archived_url missing: hei_src_012350 — add_archive_when_record_is_touched
...
- [low] Evidence archived_url missing: hei_src_012348 — add_archive_when_record_is_touched
...
- [low] Evidence archived_url missing: hei_src_012736 — add_archive_when_record_is_touched
...
- [low] Evidence archived_url missing: hei_src_012344 — add_archive_when_record_is_touched
...
- [low] Evidence archived_url missing: hei_src_012298 — add_archive_when_record_is_touched
...
- [low] Evidence archived_url missing: hei_src_012612 — add_archive_when_record_is_touched
...
- [low] Evidence archived_url missing: hei_src_012524 — add_archive_when_record_is_touched
...
- [low] Evidence archived_url missing: hei_src_012378 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012235 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012225 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012356 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012372 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012374 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012300 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012227 — add_archive_when_record_is_touched
...
- [low] Evidence archived_url missing: hei_src_012265 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012322 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012314 — add_archive_when_record_is_touched
...
- [low] Evidence archived_url missing: hei_src_012769 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012770 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012771 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_010071 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012334 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012286 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012177 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012326 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012522 — add_archive_when_record_is_touched
...
- [low] Evidence archived_url missing: hei_src_012376 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012518 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012213 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012223 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012477 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012370 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012261 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012354 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012304 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012324 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012161 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012263 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012302 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012330 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012173 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012283 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012175 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012267 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012318 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012526 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012320 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012101 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012221 — add_archive_when_record_is_touched
...
- [low] Evidence archived_url missing: hei_src_012536 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012197 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012316 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012229 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012475 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012332 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012383 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012239 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012191 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012253 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012205 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012520 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012237 — add_archive_when_record_is_touched
...
- [low] Evidence archived_url missing: hei_src_012256 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012328 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012340 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012368 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012259 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012540 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012255 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012209 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012308 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012215 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012779 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012219 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012532 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012346 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012207 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012272 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012352 — add_archive_when_record_is_touched
- [low] Evidence archived_url missing: hei_src_012281 — add_archive_when_record_is_touched

## Evidence health

- enabled: true
- evidence_with_urls: 4096
- checked: 25
- findings: 2
- without_archive_total: 438

- [high] Evidence source URL issue: hei_src_012766 — find_archive_or_replacement_evidence
- [high] Evidence source URL issue: hei_src_012767 — find_archive_or_replacement_evidence

## Watchlist state

- candidate_queue_files: 10
- raw_candidate_occurrences: 220
- unique_candidate_identities: 185
- repeated_occurrences_collapsed: 35
- class_A: 25
- class_B: 156
- class_C: 4
- manual_staging_packages: 9
- historical_resolution_files: 30
- resolution_index_entries: 109
- resolution_coverage_errors: 0

- [medium] Unresolved A candidate: ABCeX — stage_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Aegis Markets — review_keep_downgrade_or_resolve_candidate
- [medium] Unresolved A candidate: Aggregator Odos — stage_downgrade_or_resolve_candidate
- [medium] Unresolved A candidate: Aifory Pro — stage_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Amnis Finance — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Ankr — review_keep_downgrade_or_resolve_candidate
- [medium] Unresolved A candidate: App NoOnes — stage_downgrade_or_resolve_candidate
- [low] Projected candidate lacks terminal resolution: Awaken Swap — add_terminal_resolution
- [low] Unresolved B candidate: Beefy — review_keep_downgrade_or_resolve_candidate
- [low] Projected candidate lacks terminal resolution: Beets DEX V3 — add_terminal_resolution
- [low] Unresolved B candidate: Benqi Staked Avax — review_keep_downgrade_or_resolve_candidate
- [low] Projected candidate lacks terminal resolution: Bifrost DEX — add_terminal_resolution
- [low] Unresolved B candidate: Bifrost Liquid Staking — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Binance staked ETH — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Binance Staked SOL — review_keep_downgrade_or_resolve_candidate
- [medium] Unresolved A candidate: BitPapa — stage_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: BlazeStake — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Bluefin Pro — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Bybit Staked SOL — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: CIAN Yield Layer — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Coinbase Wrapped Staked ETH — review_keep_downgrade_or_resolve_candidate
- [low] Projected candidate lacks terminal resolution: Contango V2 — add_terminal_resolution
- [low] Unresolved B candidate: Crypto.com Liquid Staking — review_keep_downgrade_or_resolve_candidate
- [low] Projected candidate lacks terminal resolution: Deri V4 — add_terminal_resolution
- [low] Tracked B candidate: Derive V2 — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: DeSyn Basis Trading — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: DFDV Staked SOL — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: DoubleZero Staked SOL — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Drift Staked SOL — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Edgevana — review_keep_downgrade_or_resolve_candidate
- [low] Projected candidate lacks terminal resolution: EGAS swap — add_terminal_resolution
- [low] Projected candidate lacks terminal resolution: EXMO — add_terminal_resolution
- [medium] Unresolved A candidate: Exnode / Exnode Pay — stage_downgrade_or_resolve_candidate
- [low] Projected candidate lacks terminal resolution: FlashTrade — add_terminal_resolution
- [low] Unresolved B candidate: Fluid Lite — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Frax Ether — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Fusion by IPOR — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: GLIF — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Haedal Protocol — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Hakka Finance — review_keep_downgrade_or_resolve_candidate
- [low] Projected candidate lacks terminal resolution: Hegic — add_terminal_resolution
- [low] Unresolved B candidate: Helius Staked SOL — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Helix Perp — review_keep_downgrade_or_resolve_candidate
- [low] Projected candidate lacks terminal resolution: HTX — add_terminal_resolution
- [low] Unresolved B candidate: Hylo LSTs — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Hyperbeat Earn — review_keep_downgrade_or_resolve_candidate
- [low] Projected candidate lacks terminal resolution: Hyperliquid — add_terminal_resolution
- [low] Unresolved B candidate: Infrared Finance — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: IntentX — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: JagPool Staked SOL — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Jito Liquid Staking — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: JPool — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Jupiter Staked SOL — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Katana DEX — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Kinetiq Earn — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Kinetiq kHYPE — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Kinetiq kmHype — review_keep_downgrade_or_resolve_candidate
- [medium] Unresolved A candidate: Latest Crypto — stage_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Lazy Summer Protocol — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Lido — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: LiNEAR Protocol — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Liquid Collective — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Lista Liquid Staking — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Lulo — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Marinade Liquid Staking — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Meta Pool ETH — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Meta Pool Near — review_keep_downgrade_or_resolve_candidate
- [low] Projected candidate lacks terminal resolution: MetalX Dex — add_terminal_resolution
- [low] Unresolved B candidate: MetalX Swap — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Meteora vaults — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: mETH Protocol — review_keep_downgrade_or_resolve_candidate
- [medium] Unresolved A candidate: Monease — stage_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: MUX Perps — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: MYX Finance — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: NodeDAO — review_keep_downgrade_or_resolve_candidate
- [medium] Unresolved A candidate: NoOnecrypto — stage_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Nucleus — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Origin Ether — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Phantom SOL — review_keep_downgrade_or_resolve_candidate
- [medium] Unresolved A candidate: Rapira — stage_downgrade_or_resolve_candidate
- [low] Tracked B candidate: Rhea Dex — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Rocket Pool — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Sanctum Validator LSTs — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Sceptre Liquid — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Slingshot — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: SpringSui — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: StackingDAO — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Stader — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: stake.link liquid — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Stakee — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: StakeStone STONE — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: StakeWise V2 — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: stHYPE — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: STKESOL by SOL Strategies — review_keep_downgrade_or_resolve_candidate
- [low] Projected candidate lacks terminal resolution: Storm Trade — add_terminal_resolution
- [low] Unresolved B candidate: Sudo Perps — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Superform — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Swell Liquid Staking — review_keep_downgrade_or_resolve_candidate
- [medium] Unresolved A candidate: Tether-backed — stage_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: The Vault Liquid Staking — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Tonstakers LSD — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Toros — review_keep_downgrade_or_resolve_candidate
- [medium] Unresolved A candidate: Tradex — stage_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Usual ETH0 — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Veno Finance — review_keep_downgrade_or_resolve_candidate
- [low] Projected candidate lacks terminal resolution: Verus Market — add_terminal_resolution
- [low] Unresolved B candidate: Vesper — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: vfat.io — review_keep_downgrade_or_resolve_candidate
- [medium] Unresolved A candidate: WhiteBird — stage_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: World Markets Spot — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: xALGO Liquid Staking — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: Yearn Finance — review_keep_downgrade_or_resolve_candidate
- [low] Unresolved B candidate: YO Protocol — review_keep_downgrade_or_resolve_candidate
...
- sitemap_status: ok
- sitemap_exchange_routes_expected: 1075
- sitemap_exchange_routes_actual: 1075
- robots_checked: true
- robots_status: ok
